...
namespace runnerDotNet
{
    public class tDAL : XClass
    {
        ...
        {
			var connection = GlobalVars.cman.byId( "poolcats_at_localhost" );
		...
		public XVar swimmer
		{
			get
			{
				return Table("swimmer");
			}
		}
		public XVar swimmercontact
		{
			get
			{
				return Table("swimmercontact");
			}
		}
		public XVar swimmerpayment
		{
			get
			{
				return Table("swimmerpayment");
			}
		}
		public XVar swimmersuit
		{
			get
			{
				return Table("swimmersuit");
			}
		}
        ...
        public void FillTablesList()
        {
			...
			this.lstTables.Add(new XVar("name", "swimmer", "varname", "poolcats_at_localhost_public_swimmer", "connId", "poolcats_at_localhost", "schema", "public", "connName", "poolcatsprod at localhost"));
			this.lstTables.Add(new XVar("name", "swimmercontact", "varname", "poolcats_at_localhost_public_swimmercontact", "connId", "poolcats_at_localhost", "schema", "public", "connName", "poolcatsprod at localhost"));
			this.lstTables.Add(new XVar("name", "swimmerpayment", "varname", "poolcats_at_localhost_public_swimmerpayment", "connId", "poolcats_at_localhost", "schema", "public", "connName", "poolcatsprod at localhost"));
			this.lstTables.Add(new XVar("name", "swimmersuit", "varname", "poolcats_at_localhost_public_swimmersuit", "connId", "poolcats_at_localhost", "schema", "public", "connName", "poolcatsprod at localhost"));
        }
